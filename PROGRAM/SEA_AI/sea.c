...
// <-- KK
	...
	if (sIslandID != "")
	{
		...
		if(!bstorm) Sea.MaxSeaHeight = 5.0; // mirsaneli: small waves around islands in normal conditions
		if (bWeatherIsStorm) {Sea.MaxSeaHeight = 12.0;}	// mirsaneli: smaller waves around islands in stormy conditions
